...
function helpText() {
  return [
    ...
    '',
    '*Agente (memoria do chat):* `CHAT_HISTORY_MAX` (padrao 12), `CHAT_HISTORY_PERSIST=file` grava `data/chat-history.json`.',
    '',
    ...
    '',
    '*Abrir pedido no navegador:* defina `SISTEMA_BASE_URL` (ex.: `https://seu-dominio.github.io/sistema-pedidos`) para o agente sugerir `.../index.html?id=ID`.',
    '',
    '*PDF OS/GP no WhatsApp:* no Apps Script, propriedade `BOT_WEB_TOKEN` igual ao `APPS_SCRIPT_TOKEN` do bot; republicar Web App apos atualizar Code.gs.',
    '',
